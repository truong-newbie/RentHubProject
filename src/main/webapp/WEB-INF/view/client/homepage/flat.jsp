...
<div class="container content-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <c:if test="${empty flats}">
                <div class="alert alert-warning text-center" role="alert">
                    <i class="fas fa-exclamation-triangle me-2"></i> Hiện tại chưa có bài đăng căn hộ nào .
                </div>
            </c:if>
            <c:if test="${not empty flats}">
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="${1 eq currentPage ? 'disabled page-link': 'page-link'}"
                               href="/flat/?page=${currentPage -1}" aria-label="Previous">
                        ...
                        <c:forEach begin="0" end="${totalPages-1}" varStatus="loop">
                            <li class="page-item"><a
                                    ...
                                    href="/flat/?page=${loop.index+1}">${loop.index +1}</a>
                            </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="${totalPages eq currentPage ? 'disabled page-link': 'page-link'}"
                               href="/flat/?page=${currentPage +1}" aria-label="Next">
